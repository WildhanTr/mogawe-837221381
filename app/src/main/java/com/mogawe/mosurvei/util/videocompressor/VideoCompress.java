package com.mogawe.mosurvei.util.videocompressor;
...
public class VideoCompress {
    ...
    public static VideoCompressTask compressVideoHalfMedium(String srcPath, String destPath, CompressListener listener) {
        VideoCompressTask task = new VideoCompressTask(listener, VideoController.COMPRESS_QUALITY_HALF_MEDIUM);
        task.execute(srcPath, destPath);
        return task;
    }
    ...
    public static VideoCompressTask compressVideoHalfLow(String srcPath, String destPath, CompressListener listener) {
        VideoCompressTask task =  new VideoCompressTask(listener, VideoController.COMPRESS_QUALITY_HALF_LOW);
        task.execute(srcPath, destPath);
        return task;
    }
