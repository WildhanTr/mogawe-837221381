...
public class LatoMaterialButton extends AppCompatButton  {

    public LatoMaterialButton(Context context) {
        super(context);
    }

    public LatoMaterialButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        parseAttributes(context, attrs);
    }

    public LatoMaterialButton(Context context, AttributeSet attrs, int defStyleAttr) {
