...
public class ModulusButton extends AppCompatButton {

    public ModulusButton(Context context) {
        super(context);
    }

    public ModulusButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        parseAttributes(context, attrs);
    }

    public ModulusButton(Context context, AttributeSet attrs, int defStyleAttr) {
