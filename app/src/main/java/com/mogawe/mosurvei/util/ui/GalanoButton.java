...
public class GalanoButton extends AppCompatButton {
    public GalanoButton(Context context) {
        super(context);
    }

    public GalanoButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        parseAttributes(context, attrs);
    }

    public GalanoButton(Context context, AttributeSet attrs, int defStyleAttr) {
