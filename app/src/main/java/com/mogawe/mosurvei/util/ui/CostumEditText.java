...
public class CostumEditText extends AppCompatEditText {
    ...
    public CostumEditText(@NonNull Context context) {
        super(context);
        initView();
    }

    public CostumEditText(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initView();
    }
    ...
    public CostumEditText(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
