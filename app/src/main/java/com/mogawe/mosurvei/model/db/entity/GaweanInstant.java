...
public class GaweanInstant implements Serializable {
    ...
    @SerializedName("offeredJob")
    public Task getOfferedJob() {
        return offeredJob;
    }

    public void setOfferedJob(Task offeredJob) {
    ...
    public void setOfferExpiredDate(String offerExpiredDate) {
        this.offerExpiredDate = offerExpiredDate;
    }
